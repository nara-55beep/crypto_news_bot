...
BOT_RESET_TS: dict = {}
KNOWN_BOT_KEYS = ["newsbot", "sniperbot", "arb", "fv", "trend", "ainews", "claudehaiku", "tvstrats", "meanrev",
...
<script>
  ...
  const BOT_PANELS={'news-panel':'newsbot','sniper-panel':'sniperbot','arb-panel':'arb','fv-panel':'fv',
